        ...
        <section className="relative flex items-center min-h-[85vh] w-full bg-[url('../img/destinos.jpg')] bg-cover bg-center px-8 md:px-20">
          ...
          <div className="relative z-10 flex flex-col gap-6 max-w-xl text-white">
            ...
            <p className="text-lg md:text-xl">
              Explore the world with us and live unforgettable experiences.
            </p>
            <button className="bg-blue-700 hover:bg-blue-800 transition-all text-white text-lg md:text-xl px-8 py-4 rounded-2xl w-fit cursor-pointer">
              Find tours
            </button>
          </div>
        </section>
        ...
        <section className="w-full flex items-center justify-center p-8">
          <div className="w-full max-w-4xl">
            <form className="w-full flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 bg-white p-4 shadow-xl shadow-gray-300 rounded-2xl">
              <select className="w-full text-center p-4 border-2 border-black bg-white rounded-2xl" name="destination">
              ...
              <select className="w-full text-center p-4 border-2 border-black bg-white rounded-2xl" name="date">
                <option value="" disabled selected>Select type</option>
                <option value="italy">Italy</option>
              </select>
              <select className="w-full text-center p-4 border-2 border-black bg-white rounded-2xl" name="type">
              ...
              <input
                type="submit"
                value="Search"
                className="bg-blue-700 text-white p-4 rounded-2xl w-full cursor-pointer hover:bg-blue-600 transition-all"
              />
            </form>
          </div>
        </section>
          ...
          <div className="w-full max-w-6xl flex flex-col items-start gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div
                  key={idx}
                  className="flex flex-col items-center gap-2 p-4 bg-white rounded-3xl shadow-lg hover:shadow-xl hover:scale-105 transition duration-300 ease-out cursor-pointer"
                >
        ...
        <section className="w-full flex items-center justify-center px-6 py-12">
          <div className="max-w-3xl text-center flex flex-col gap-4">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              We offer customized tours, exclusive services, and we can make you sure that you will never forget every experience.
            </p>
          </div>
        </section>
      </main>
